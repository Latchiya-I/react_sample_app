...
const top100Films = [
  ...
  { label: 'thara', year: 2002 },
  { label: 'iyappan', year: 1995 },
  { label: 'agilan', year: 1991 },
  { label: "sakthi priya", year: 1946 },
  { label: 'latchiya', year: 2005 },
...
<div className='App'>
   ...
   <Autocomplete
    ...
    <Autocomplete
      ...
      options={names}
      sx={{ width: 300 }}
      renderInput={(params) => <TextField {...params} label=" Actor name" />}
    />
